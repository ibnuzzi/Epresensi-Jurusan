      ...
      <div class="row m-0">
        ...
        <div class="col-xl-7 p-0">
          <div class="login-card">
            <div>
              <div><a class="logo text-center" href="index.html"><img class="img-fluid for-light" src="{{ asset('assets/images/smk/Logo SMKN 2 Trenggalek.png') }}" style="width: 50%" alt="logo image"></a></div>
              <div class="login-main">
                <form class="theme-form">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row g-2">
                      <div class="col-12">
                        <input class="form-control" type="text" required="" placeholder="Masukkan Namamu">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group mb-0">
                    <button class="btn btn-primary btn-block w-100 mt-3" type="submit">Daftar Sekarang</button>
                  </div>
